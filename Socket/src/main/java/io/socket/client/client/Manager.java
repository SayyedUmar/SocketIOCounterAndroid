...
import io.socket.client.backo.Backoff;
import io.socket.client.parser.DecodingException;
import io.socket.client.parser.IOParser;
import io.socket.client.parser.Packet;
import io.socket.client.parser.Parser;
import io.socket.engine.emitter.Emitter;
import io.socket.engine.thread.EventThread;
import okhttp3.Call;
...
public class Manager extends Emitter {
    ...
    /*package*/ io.socket.engine.engineio.client.Socket engine;
    ...
    public Manager open(final OpenCallback fn) {
        EventThread.exec(new Runnable() {
            ...
            public void run() {
                ...
                final io.socket.engine.engineio.client.Socket socket = Manager.this.engine;
    ...
    private void onopen() {
        ...
        final io.socket.engine.engineio.client.Socket socket = this.engine;
    ...
    private static class Engine extends io.socket.engine.engineio.client.Socket {
    ...
    public static class Options extends io.socket.engine.engineio.client.Socket.Options {
